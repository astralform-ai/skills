...
#   3. Clones under $HOME/work — not /tmp, which is RAM carved out of the 4 GB,
#      and not /workspace, which is a network mount that is slow and unreliable
#      for the many small files git writes.
